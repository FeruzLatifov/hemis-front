...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-50 min-w-[8rem] overflow-hidden rounded-[6px] border border-[var(--border-color-pro)] bg-[var(--card-bg)] p-1 text-[var(--text-primary)] shadow-[0_1px_2px_rgba(15,23,42,0.04)]',
      className,
    )}
    {...props}
  />
