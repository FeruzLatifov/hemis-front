...
export default function DuplicateDetailDrawer({ pinfl, onClose }: DuplicateDetailDrawerProps) {
  ...
  return (
    <DetailDrawer
      ...
      icon={<AlertTriangle className="text-primary h-6 w-6" aria-hidden="true" />}
      title={t('Duplicate analysis')}
      description={`PINFL: ${pinfl}`}
      footer={
          ...
          {reasonStyle && (
            <div className={`rounded-lg border p-4 ${reasonStyle.bg}`}>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className={`font-medium ${reasonStyle.text}`}>{detail.reasonDescription}</p>
